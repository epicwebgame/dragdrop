...
| ---- | -------- | ----------- |
| 1. | a | | |
| 2. | abbr | <p>The HTML `<abbr>` element represents an abbreviation or acronym and optionally provides a full description for it. If present, the `title` attribute must contain this full description and nothing else.</p><p>For e.g.</p><p> `<abbr title = "Laugh out Loud">LOL</abbr>`</p>  | |
