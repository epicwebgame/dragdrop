namespace ObservableNumberGenerator.ObservableImplementationFromScratch.Cold
{
    public class OddNumbers : RandomNumbers
    {
        public OddNumbers(int maxNumbersToGenerate,
